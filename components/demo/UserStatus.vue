<template>
  <div class="bg-white overflow-hidden sm:rounded-lg sm:shadow col-span-1">
...
export default {
  ...
  mounted() {
    this.user = [
      ...
      {property: "Email", value: (this.$auth.user && this.$auth.user.email) || '-'},
      {property: "Language", value: this.lang}
    ]
  }
}
</script>
