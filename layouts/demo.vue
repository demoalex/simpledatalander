<template>
  <div>
    <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
      ...
      <div class="lg:hidden">
        <button class="navbar-burger flex items-center text-blue-600 p-3 focus:outline-none" type="button" @click="toggleMenu">
      ...
      <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
        <li><nuxt-link class="text-sm text-gray-400 hover:text-gray-500" to="/demo/user">User</nuxt-link></li>
        <li class="text-gray-300">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
          </svg>
        </li>
        <li><nuxt-link class="text-sm text-gray-400 hover:text-gray-500" to="/demo/intercom">Intercom</nuxt-link></li>
        <li class="text-gray-300">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
          </svg>
    ...
    <div class="navbar-menu relative z-50 hidden">
      ...
      <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
        <div class="flex items-center mb-8">
          <nuxt-link class="mr-auto flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0" to="/demo/intercom">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round"
                 stroke-linejoin="round" stroke-width="2" class="w-12 h-12 text-white p-2 bg-indigo-500 rounded-full"
                 viewBox="0 0 24 24">
              <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path>
          ...
          <button class="navbar-close" @click="toggleMenu" type="button">
        ...
        <div>
          <ul>
            <li class="mb-1">
              <nuxt-link class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" to="#">Intercom</nuxt-link>
            </li>
            <li class="mb-1">
