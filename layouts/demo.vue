          ...
          <div class="mt-5 flex-1 h-0 overflow-y-auto">
            <nav class="px-2 space-y-1">
              ...
              <template v-for="(item, $index) in menu">
                <nuxt-link  class="text-indigo-100 hover:bg-indigo-600 group flex items-center px-4 py-2 text-sm font-medium rounded-md ransition ease-out duration-700" :to="item.to">
                  <svg class="mr-3 flex-shrink-0 h-6 w-6 text-indigo-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" @click="toggleMenu">
