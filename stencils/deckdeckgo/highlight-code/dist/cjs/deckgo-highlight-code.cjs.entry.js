...
const deckdeckgoHighlightCodeLanguages = require('./deckdeckgo-highlight-code-languages-cd3e7e9c.js');
...
function loadTheme(theme) {
  ...
  switch (theme) {
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme['3024-NIGHT']:
      return Promise.resolve().then(function () { return require('./3024-night-4262d2a3.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme['A11Y-DARK']:
      return Promise.resolve().then(function () { return require('./a11y-dark-c6f60467.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme['BASE16-DARK']:
      return Promise.resolve().then(function () { return require('./base16-dark-d1487df1.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme['BASE16-LIGHT']:
      return Promise.resolve().then(function () { return require('./base16-light-633c9aff.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.BLACKBOARD:
      return Promise.resolve().then(function () { return require('./blackboard-4066b894.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.COBALT:
      return Promise.resolve().then(function () { return require('./cobalt-e53cb040.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.DUOTONE:
      return Promise.resolve().then(function () { return require('./duotone-974448a8.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.HOPSCOTCH:
      return Promise.resolve().then(function () { return require('./hopscotch-7344e034.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.LUCARIO:
      return Promise.resolve().then(function () { return require('./lucario-d2c257ec.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.MATERIAL:
      return Promise.resolve().then(function () { return require('./material-39d2cbe5.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.MONOKAI:
      return Promise.resolve().then(function () { return require('./monokai-bef4fa6a.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme['NIGHT-OWL']:
      return Promise.resolve().then(function () { return require('./night-owl-1ed27014.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.NORD:
      return Promise.resolve().then(function () { return require('./nord-34e6a28b.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme['OCEANIC-NEXT']:
      return Promise.resolve().then(function () { return require('./oceanic-next-6ae3ec4f.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme['ONE-DARK']:
      return Promise.resolve().then(function () { return require('./one-dark-bd2eb2a0.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme['ONE-LIGHT']:
      return Promise.resolve().then(function () { return require('./one-light-476c927e.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.PANDA:
      return Promise.resolve().then(function () { return require('./panda-86d55d62.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.PARAISO:
      return Promise.resolve().then(function () { return require('./paraiso-e8144c44.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.SETI:
      return Promise.resolve().then(function () { return require('./seti-2e70044d.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme['SHADES-OF-PURPLE']:
      return Promise.resolve().then(function () { return require('./shades-of-purple-f3b0acff.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme['SOLARIZED-DARK']:
      return Promise.resolve().then(function () { return require('./solarized-dark-eaed57ec.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme['SOLARIZED-LIGHT']:
      return Promise.resolve().then(function () { return require('./solarized-light-6bfc21a2.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.SYNTHWAVE:
      return Promise.resolve().then(function () { return require('./synthwave-3e4b9467.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.TWILIGHT:
      return Promise.resolve().then(function () { return require('./twilight-d719f45a.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.VERMINAL:
      return Promise.resolve().then(function () { return require('./verminal-692a9e97.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.VSCODE:
      return Promise.resolve().then(function () { return require('./vscode-d1d4d3c8.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.YETI:
      return Promise.resolve().then(function () { return require('./yeti-30f3259d.js'); });
    case deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.ZENBURN:
...
const loadGoogleFonts = async (terminal) => {
  if (terminal === deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeTerminal.UBUNTU) {
...
const DeckdeckgoHighlightCode = class {
  constructor(hostRef) {
     ...
     */
    this.terminal = deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeTerminal.CARBON;
    /**
     ...
     */
    this.theme = deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeCarbonTheme.DRACULA;
  ...
  async loadTheme() {
    if (this.terminal !== deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeTerminal.CARBON || !this.theme) {
  ...
  async parse() {
    if (!this.language || !deckdeckgoHighlightCodeLanguages.deckdeckgoHighlightCodeLanguages[this.language]) {
      return;
    }
  ...
  async initLanguagesToLoad() {
    ...
    const definition = deckdeckgoHighlightCodeLanguages.deckdeckgoHighlightCodeLanguages[this.language];
  ...
  render() {
    var _a;
    const hostClass = {
      'deckgo-highlight-code-carbon': this.terminal === deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeTerminal.CARBON,
      'deckgo-highlight-code-ubuntu': this.terminal === deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeTerminal.UBUNTU
    };
    if (this.terminal === deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeTerminal.CARBON) {
      hostClass[`deckgo-highlight-code-theme-${this.theme}`] = true;
    }
    return (index.h(index.Host, { class: hostClass, onClick: () => this.edit() }, this.renderCarbon(), this.renderUbuntu(), this.renderHighlightStyle(), index.h("div", { class: "container", ref: (el) => (this.refContainer = el) }, index.h("code", { class: ((_a = this.highlightLines) === null || _a === void 0 ? void 0 : _a.length) > 0 ? 'highlight' : undefined, contentEditable: this.editable, onBlur: async () => await this.applyCode(), onInput: () => this.inputCode(), onKeyDown: ($event) => this.catchTab($event), ref: (el) => (this.refCode = el) }), index.h("slot", { name: "code" }))));
  }
  ...
  renderUbuntu() {
    if (this.terminal !== deckdeckgoHighlightCodeLanguages.DeckdeckgoHighlightCodeTerminal.UBUNTU) {
      return undefined;
    }
