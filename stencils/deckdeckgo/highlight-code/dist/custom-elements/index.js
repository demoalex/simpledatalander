...
const DeckdeckgoHighlightCode = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    attachShadow(this);
...
const DeckgoHighlightCode = /*@__PURE__*/proxyCustomElement(DeckdeckgoHighlightCode, [1,"deckgo-highlight-code",{"language":[513],"highlightLines":[513,"highlight-lines"],"lineNumbers":[516,"line-numbers"],"terminal":[513],"editable":[4],"theme":[513],"revealProgress":[1025,"reveal-progress"],"themeStyle":[32],"languagesToLoad":[32],"loaded":[32],"highlightRows":[32]},[[4,"prismLanguageLoaded","languageLoaded"]]]);
...
export { DeckdeckgoHighlightCodeCarbonTheme, DeckdeckgoHighlightCodeTerminal, DeckgoHighlightCode, deckdeckgoHighlightCodeLanguages, defineCustomElements };
