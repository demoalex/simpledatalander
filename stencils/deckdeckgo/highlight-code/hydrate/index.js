...
const BUILD = /* deckdeckgo-highlight-code */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: true, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: false, disconnectedCallback: false, dynamicImportShim: false, element: false, event: true, hasRenderFn: true, hostListener: true, hostListenerTarget: true, hostListenerTargetBody: false, hostListenerTargetDocument: true, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: true, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: true, propMutable: true, propNumber: false, propString: true, reflect: true, safari10: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: true, vdomKey: true, vdomListener: true, vdomPropOrAttr: true, vdomRef: true, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: true, watchCallback: true };
...
}, getHostListenerTarget = (e, t) => 4 & t ? doc : e, hostListenerOpts = e => 0 != (2 & e), XLINK_NS = "http://www.w3.org/1999/xlink";
...
function loadTheme(theme) {
  ...
  switch (theme) {
    case DeckdeckgoHighlightCodeCarbonTheme['3024-NIGHT']:
      return Promise.resolve().then(function () { return _3024Night; });
    case DeckdeckgoHighlightCodeCarbonTheme['A11Y-DARK']:
      return Promise.resolve().then(function () { return a11yDark; });
    case DeckdeckgoHighlightCodeCarbonTheme['BASE16-DARK']:
      return Promise.resolve().then(function () { return base16Dark; });
    case DeckdeckgoHighlightCodeCarbonTheme['BASE16-LIGHT']:
      return Promise.resolve().then(function () { return base16Light; });
    case DeckdeckgoHighlightCodeCarbonTheme.BLACKBOARD:
      return Promise.resolve().then(function () { return blackboard; });
    case DeckdeckgoHighlightCodeCarbonTheme.COBALT:
      return Promise.resolve().then(function () { return cobalt; });
    case DeckdeckgoHighlightCodeCarbonTheme.DUOTONE:
      return Promise.resolve().then(function () { return duotone; });
    case DeckdeckgoHighlightCodeCarbonTheme.HOPSCOTCH:
      return Promise.resolve().then(function () { return hopscotch; });
    case DeckdeckgoHighlightCodeCarbonTheme.LUCARIO:
      return Promise.resolve().then(function () { return lucario; });
    case DeckdeckgoHighlightCodeCarbonTheme.MATERIAL:
      return Promise.resolve().then(function () { return material; });
    case DeckdeckgoHighlightCodeCarbonTheme.MONOKAI:
      return Promise.resolve().then(function () { return monokai; });
    case DeckdeckgoHighlightCodeCarbonTheme['NIGHT-OWL']:
      return Promise.resolve().then(function () { return nightOwl; });
    case DeckdeckgoHighlightCodeCarbonTheme.NORD:
      return Promise.resolve().then(function () { return nord; });
    case DeckdeckgoHighlightCodeCarbonTheme['OCEANIC-NEXT']:
      return Promise.resolve().then(function () { return oceanicNext; });
    case DeckdeckgoHighlightCodeCarbonTheme['ONE-DARK']:
      return Promise.resolve().then(function () { return oneDark; });
    case DeckdeckgoHighlightCodeCarbonTheme['ONE-LIGHT']:
      return Promise.resolve().then(function () { return oneLight; });
    case DeckdeckgoHighlightCodeCarbonTheme.PANDA:
      return Promise.resolve().then(function () { return panda; });
    case DeckdeckgoHighlightCodeCarbonTheme.PARAISO:
      return Promise.resolve().then(function () { return paraiso; });
    case DeckdeckgoHighlightCodeCarbonTheme.SETI:
      return Promise.resolve().then(function () { return seti; });
    case DeckdeckgoHighlightCodeCarbonTheme['SHADES-OF-PURPLE']:
      return Promise.resolve().then(function () { return shadesOfPurple; });
    case DeckdeckgoHighlightCodeCarbonTheme['SOLARIZED-DARK']:
      return Promise.resolve().then(function () { return solarizedDark; });
    case DeckdeckgoHighlightCodeCarbonTheme['SOLARIZED-LIGHT']:
      return Promise.resolve().then(function () { return solarizedLight; });
    case DeckdeckgoHighlightCodeCarbonTheme.SYNTHWAVE:
      return Promise.resolve().then(function () { return synthwave; });
    case DeckdeckgoHighlightCodeCarbonTheme.TWILIGHT:
      return Promise.resolve().then(function () { return twilight; });
    case DeckdeckgoHighlightCodeCarbonTheme.VERMINAL:
      return Promise.resolve().then(function () { return verminal; });
    case DeckdeckgoHighlightCodeCarbonTheme.VSCODE:
      return Promise.resolve().then(function () { return vscode; });
    case DeckdeckgoHighlightCodeCarbonTheme.YETI:
      return Promise.resolve().then(function () { return yeti; });
    case DeckdeckgoHighlightCodeCarbonTheme.ZENBURN:
      return Promise.resolve().then(function () { return zenburn; });
    default:
      return Promise.resolve().then(function () { return dracula; });
  }
}
...
const deckdeckgoHighlightCodeCss = "/*!@code[class*=\"language-\"],\npre[class*=\"language-\"]*/code[class*=\"language-\"].sc-deckgo-highlight-code,pre[class*=\"language-\"].sc-deckgo-highlight-code{color:black;background:none;text-shadow:0 1px white;font-family:Consolas, Monaco, 'Andale Mono', 'Ubuntu Mono', monospace;font-size:1em;text-align:left;white-space:pre;word-spacing:normal;word-break:normal;word-wrap:normal;line-height:1.5;-moz-tab-size:4;-o-tab-size:4;tab-size:4;-webkit-hyphens:none;-moz-hyphens:none;-ms-hyphens:none;hyphens:none}/*!@pre[class*=\"language-\"]::-moz-selection, pre[class*=\"language-\"] ::-moz-selection,\ncode[class*=\"language-\"]::-moz-selection, code[class*=\"language-\"] ::-moz-selection*/pre[class*=\"language-\"].sc-deckgo-highlight-code::-moz-selection,pre[class*=\"language-\"].sc-deckgo-highlight-code .sc-deckgo-highlight-code::-moz-selection,code[class*=\"language-\"].sc-deckgo-highlight-code::-moz-selection,code[class*=\"language-\"].sc-deckgo-highlight-code .sc-deckgo-highlight-code::-moz-selection{text-shadow:none;background:#b3d4fc}/*!@pre[class*=\"language-\"]::selection, pre[class*=\"language-\"] ::selection,\ncode[class*=\"language-\"]::selection, code[class*=\"language-\"] ::selection*/pre[class*=\"language-\"].sc-deckgo-highlight-code::selection,pre[class*=\"language-\"].sc-deckgo-highlight-code .sc-deckgo-highlight-code::selection,code[class*=\"language-\"].sc-deckgo-highlight-code::selection,code[class*=\"language-\"].sc-deckgo-highlight-code .sc-deckgo-highlight-code::selection{text-shadow:none;background:#b3d4fc}@media print{/*!@code[class*=\"language-\"],\n\tpre[class*=\"language-\"]*/code[class*=\"language-\"].sc-deckgo-highlight-code,pre[class*=\"language-\"].sc-deckgo-highlight-code{text-shadow:none}}/*!@pre[class*=\"language-\"]*/pre[class*=\"language-\"].sc-deckgo-highlight-code{padding:1em;margin:.5em 0;overflow:auto}/*!@:not(pre) > code[class*=\"language-\"],\npre[class*=\"language-\"]*/.sc-deckgo-highlight-code:not(pre)>code[class*=\"language-\"].sc-deckgo-highlight-code,pre[class*=\"language-\"].sc-deckgo-highlight-code{background:#f5f2f0}/*!@:not(pre) > code[class*=\"language-\"]*/.sc-deckgo-highlight-code:not(pre)>code[class*=\"language-\"].sc-deckgo-highlight-code{padding:.1em;border-radius:.3em;white-space:normal}/*!@.token.comment,\n.token.prolog,\n.token.doctype,\n.token.cdata*/.token.comment.sc-deckgo-highlight-code,.token.prolog.sc-deckgo-highlight-code,.token.doctype.sc-deckgo-highlight-code,.token.cdata.sc-deckgo-highlight-code{color:slategray}/*!@.token.punctuation*/.token.punctuation.sc-deckgo-highlight-code{color:#999}/*!@.token.namespace*/.token.namespace.sc-deckgo-highlight-code{opacity:.7}/*!@.token.property,\n.token.tag,\n.token.boolean,\n.token.number,\n.token.constant,\n.token.symbol,\n.token.deleted*/.token.property.sc-deckgo-highlight-code,.token.tag.sc-deckgo-highlight-code,.token.boolean.sc-deckgo-highlight-code,.token.number.sc-deckgo-highlight-code,.token.constant.sc-deckgo-highlight-code,.token.symbol.sc-deckgo-highlight-code,.token.deleted.sc-deckgo-highlight-code{color:#905}/*!@.token.selector,\n.token.attr-name,\n.token.string,\n.token.char,\n.token.builtin,\n.token.inserted*/.token.selector.sc-deckgo-highlight-code,.token.attr-name.sc-deckgo-highlight-code,.token.string.sc-deckgo-highlight-code,.token.char.sc-deckgo-highlight-code,.token.builtin.sc-deckgo-highlight-code,.token.inserted.sc-deckgo-highlight-code{color:#690}/*!@.token.operator,\n.token.entity,\n.token.url,\n.language-css .token.string,\n.style .token.string*/.token.operator.sc-deckgo-highlight-code,.token.entity.sc-deckgo-highlight-code,.token.url.sc-deckgo-highlight-code,.language-css.sc-deckgo-highlight-code .token.string.sc-deckgo-highlight-code,.style.sc-deckgo-highlight-code .token.string.sc-deckgo-highlight-code{color:#9a6e3a;background:hsla(0, 0%, 100%, .5)}/*!@.token.atrule,\n.token.attr-value,\n.token.keyword*/.token.atrule.sc-deckgo-highlight-code,.token.attr-value.sc-deckgo-highlight-code,.token.keyword.sc-deckgo-highlight-code{color:#07a}/*!@.token.function,\n.token.class-name*/.token.function.sc-deckgo-highlight-code,.token.class-name.sc-deckgo-highlight-code{color:#DD4A68}/*!@.token.regex,\n.token.important,\n.token.variable*/.token.regex.sc-deckgo-highlight-code,.token.important.sc-deckgo-highlight-code,.token.variable.sc-deckgo-highlight-code{color:#e90}/*!@.token.important,\n.token.bold*/.token.important.sc-deckgo-highlight-code,.token.bold.sc-deckgo-highlight-code{font-weight:bold}/*!@.token.italic*/.token.italic.sc-deckgo-highlight-code{font-style:italic}/*!@.token.entity*/.token.entity.sc-deckgo-highlight-code{cursor:help}/*!@:host ::slotted([slot=code])*/.sc-deckgo-highlight-code-h .sc-deckgo-highlight-code-s>[slot=code]{display:none}/*!@:host([editable])*/[editable].sc-deckgo-highlight-code-h{cursor:var(--deckgo-editable-cursor, text)}/*!@:host([editable]) code:empty:not(:focus):after*/[editable].sc-deckgo-highlight-code-h code.sc-deckgo-highlight-code:empty:not(:focus):after{content:var(--deckgo-highlight-code-empty-text, \"Click to add your code\")}/*!@:host(.deckgo-highlight-code-carbon)*/.deckgo-highlight-code-carbon.sc-deckgo-highlight-code-h{display:var(--deckgo-highlight-code-carbon-display, block);overflow:var(--deckgo-highlight-code-carbon-overflow, auto);border:var(--deckgo-highlight-code-carbon-border);border-radius:var(--deckgo-highlight-code-carbon-border-radius, 4px);background:var(--deckgo-highlight-code-carbon-background, #282a36);color:var(--deckgo-highlight-code-carbon-color, white);box-shadow:var(--deckgo-highlight-code-carbon-box-shadow, rgba(0, 0, 0, 0.55) 0 8px 16px);margin:var(--deckgo-highlight-code-carbon-margin, 16px 0)}/*!@:host(.deckgo-highlight-code-carbon) div.container*/.deckgo-highlight-code-carbon.sc-deckgo-highlight-code-h div.container.sc-deckgo-highlight-code{margin:var(--deckgo-highlight-code-margin, 0 0 1em)}/*!@:host(.deckgo-highlight-code-carbon) ::slotted([slot=code])*/.sc-deckgo-highlight-code-h.deckgo-highlight-code-carbon .sc-deckgo-highlight-code-s>[slot=code]{color:var(--deckgo-highlight-code-carbon-color, white)}/*!@:host(.deckgo-highlight-code-ubuntu)*/.deckgo-highlight-code-ubuntu.sc-deckgo-highlight-code-h{display:var(--deckgo-highlight-code-ubuntu-display, block);overflow:var(--deckgo-highlight-code-ubuntu-overflow, auto);border:var(--deckgo-highlight-code-ubuntu-border);border-radius:var(--deckgo-highlight-code-ubuntu-border-radius, 6px 6px 0 0);background:var(--deckgo-highlight-code-ubuntu-background, #4c1e3d);color:var(--deckgo-highlight-code-ubuntu-color, #ddd);box-shadow:var(--deckgo-highlight-code-ubuntu-box-shadow, 2px 4px 10px rgba(0, 0, 0, 0.5));margin:var(--deckgo-highlight-code-ubuntu-margin, 16px 0)}/*!@:host(.deckgo-highlight-code-ubuntu) div.container*/.deckgo-highlight-code-ubuntu.sc-deckgo-highlight-code-h div.container.sc-deckgo-highlight-code{margin:var(--deckgo-highlight-code-margin, 0 0 16px);padding:var(--deckgo-highlight-code-padding, 2px 0 0);background:transparent}/*!@:host(.deckgo-highlight-code-ubuntu) div.container code*/.deckgo-highlight-code-ubuntu.sc-deckgo-highlight-code-h div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code{font-family:var(--deckgo-highlight-code-font-family, \"Ubuntu mono\")}/*!@:host(.deckgo-highlight-code-ubuntu) div.container code > div.line-number:before*/.deckgo-highlight-code-ubuntu.sc-deckgo-highlight-code-h div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code>div.line-number.sc-deckgo-highlight-code:before{background:var(--deckgo-highlight-code-ubuntu-background, #4c1e3d)}/*!@:host(.deckgo-highlight-code-ubuntu) ::slotted([slot=code])*/.sc-deckgo-highlight-code-h.deckgo-highlight-code-ubuntu .sc-deckgo-highlight-code-s>[slot=code]{color:var(--deckgo-highlight-code-ubuntu-color, #ddd)}/*!@div.container*/div.container.sc-deckgo-highlight-code{color:var(--deckgo-highlight-code-color, inherit);background:var(--deckgo-highlight-code-background);padding:var(--deckgo-highlight-code-padding, 0 16px);border-radius:var(--deckgo-highlight-code-border-radius);margin:var(--deckgo-highlight-code-margin, 16px 0);transform-origin:bottom left;transition:all 0.2s ease-in-out;transform:scale(var(--deckgo-highlight-code-zoom, 1));direction:var(--deckgo-highlight-code-direction, ltr);text-align:var(--deckgo-highlight-code-text-align, start);width:var(--deckgo-highlight-code-container-width);height:var(--deckgo-highlight-code-container-height);display:var(--deckgo-highlight-code-container-display, block);justify-content:var(--deckgo-highlight-code-container-justify-content);flex-direction:var(--deckgo-highlight-code-container-flex-direction);align-items:var(--deckgo-highlight-code-container-align-items)}/*!@div.container code*/div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code{overflow-y:var(--deckgo-highlight-code-scroll, auto);white-space:var(--deckgo-highlight-code-white-space, pre-wrap);font-size:var(--deckgo-highlight-code-font-size);font-family:var(--deckgo-highlight-code-font-family, monospace);line-height:var(--deckgo-highlight-code-line-height);display:var(--deckgo-highlight-code-display, block);counter-reset:linenumber;height:var(--deckgo-highlight-code-height, 100%);width:var(--deckgo-highlight-code-width)}/*!@div.container code > div.line-number*/div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code>div.line-number.sc-deckgo-highlight-code{counter-increment:linenumber;position:relative;padding-left:3.5em}/*!@div.container code > div.line-number:before*/div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code>div.line-number.sc-deckgo-highlight-code:before{content:counter(linenumber);display:inline-block;position:absolute;top:0;bottom:0;left:0;width:2.5em;background:var(--deckgo-highlight-code-line-numbers-background);border-right:var(--deckgo-highlight-code-line-numbers-border-right, 1px solid rgba(var(--deckgo-highlight-code-token-comment-rgb, 98, 114, 164), 0.32));color:var(--deckgo-lowlight-code-line-numbers-color, rgba(var(--deckgo-highlight-code-token-comment-rgb, 98, 114, 164), 0.32))}/*!@div.container code span.deckgo-highlight-code-anchor-hidden*/div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code span.deckgo-highlight-code-anchor-hidden.sc-deckgo-highlight-code{visibility:hidden}/*!@div.container code.highlight div > **/div.container.sc-deckgo-highlight-code code.highlight.sc-deckgo-highlight-code div.sc-deckgo-highlight-code>*.sc-deckgo-highlight-code{color:var(--deckgo-lowlight-code-line-color);background:var(--deckgo-lowlight-code-line-background);border-top:var(--deckgo-lowlight-code-line-border-top);border-bottom:var(--deckgo-lowlight-code-line-border-bottom);font-weight:var(--deckgo-lowlight-code-line-font-weight);opacity:var(--deckgo-lowlight-code-line-opacity, 0.32)}/*!@div.container code.highlight.animate div > **/div.container.sc-deckgo-highlight-code code.highlight.animate.sc-deckgo-highlight-code div.sc-deckgo-highlight-code>*.sc-deckgo-highlight-code{transition:var(--deckgo-highlight-code-line-transition, all 0.35s ease-in)}/*!@div.container code.highlight.animate > div.line-number:before*/div.container.sc-deckgo-highlight-code code.highlight.animate.sc-deckgo-highlight-code>div.line-number.sc-deckgo-highlight-code:before{transition:var(--deckgo-highlight-code-line-transition, all 0.35s ease-in)}/*!@div.container code .language-css .token.string:not(.deckgo-highlight-code-line),\ndiv.container code .style .token.string:not(.deckgo-highlight-code-line),\ndiv.container code .token.entity:not(.deckgo-highlight-code-line),\ndiv.container code .token.operator:not(.deckgo-highlight-code-line),\ndiv.container code .token.url:not(.deckgo-highlight-code-line)*/div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .language-css.sc-deckgo-highlight-code .token.string.sc-deckgo-highlight-code:not(.deckgo-highlight-code-line),div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .style.sc-deckgo-highlight-code .token.string.sc-deckgo-highlight-code:not(.deckgo-highlight-code-line),div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.entity.sc-deckgo-highlight-code:not(.deckgo-highlight-code-line),div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.operator.sc-deckgo-highlight-code:not(.deckgo-highlight-code-line),div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.url.sc-deckgo-highlight-code:not(.deckgo-highlight-code-line){background:inherit}/*!@div.container code .token.comment,\ndiv.container code .token.prolog,\ndiv.container code .token.doctype,\ndiv.container code .token.cdata*/div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.comment.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.prolog.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.doctype.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.cdata.sc-deckgo-highlight-code{color:var(--deckgo-highlight-code-token-comment, #6272a4)}/*!@div.container code .token.punctuation*/div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.punctuation.sc-deckgo-highlight-code{color:var(--deckgo-highlight-code-token-punctuation, #6272a4)}/*!@div.container code .token.property,\ndiv.container code .token.tag,\ndiv.container code .token.boolean,\ndiv.container code .token.number,\ndiv.container code .token.constant,\ndiv.container code .token.symbol,\ndiv.container code .token.deleted*/div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.property.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.tag.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.boolean.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.number.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.constant.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.symbol.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.deleted.sc-deckgo-highlight-code{color:var(--deckgo-highlight-code-token-property, #bd93f9)}/*!@div.container code .token.selector,\ndiv.container code .token.attr-name,\ndiv.container code .token.string,\ndiv.container code .token.char,\ndiv.container code .token.builtin,\ndiv.container code .token.inserted*/div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.selector.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.attr-name.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.string.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.char.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.builtin.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.inserted.sc-deckgo-highlight-code{color:var(--deckgo-highlight-code-token-selector, #50fa7b)}/*!@div.container code .token.operator,\ndiv.container code .token.entity,\ndiv.container code .token.url,\ndiv.container code .language-css .token.string,\ndiv.container code .style .token.string*/div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.operator.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.entity.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.url.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .language-css.sc-deckgo-highlight-code .token.string.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .style.sc-deckgo-highlight-code .token.string.sc-deckgo-highlight-code{color:var(--deckgo-highlight-code-token-operator, #ff79c6)}/*!@div.container code .token.atrule,\ndiv.container code .token.attr-value,\ndiv.container code .token.keyword*/div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.atrule.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.attr-value.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.keyword.sc-deckgo-highlight-code{color:var(--deckgo-highlight-code-token-atrule, #ff79c6)}/*!@div.container code .token.function,\ndiv.container code .token.class-name*/div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.function.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.class-name.sc-deckgo-highlight-code{color:var(--deckgo-highlight-code-token-function, #ffb86c)}/*!@div.container code .token.regex,\ndiv.container code .token.important,\ndiv.container code .token.variable*/div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.regex.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.important.sc-deckgo-highlight-code,div.container.sc-deckgo-highlight-code code.sc-deckgo-highlight-code .token.variable.sc-deckgo-highlight-code{color:var(--deckgo-highlight-code-token-regex, #f1fa8c)}/*!@div.carbon*/div.carbon.sc-deckgo-highlight-code{display:flex;justify-content:flex-start;padding:var(--deckgo-highlight-code-carbon-header-padding, 0.5em 1em);margin:var(--deckgo-highlight-code-carbon-header-margin, 0)}/*!@div.carbon > div*/div.carbon.sc-deckgo-highlight-code>div.sc-deckgo-highlight-code{display:var(--deckgo-highlight-code-carbon-toolbar-display, block);width:var(--deckgo-highlight-code-carbon-header-button-width, 0.75em);height:var(--deckgo-highlight-code-carbon-header-button-height, 0.75em);border-radius:var(--deckgo-highlight-code-carbon-header-button-border-radius, 50%);margin:var(--deckgo-highlight-code-carbon-header-button-margin, 0.5em 0.375em 0.5em 0)}/*!@div.carbon > div.red*/div.carbon.sc-deckgo-highlight-code>div.red.sc-deckgo-highlight-code{background:var(--deckgo-highlight-code-carbon-header-button-red-background, #ff5f56);border:var(--deckgo-highlight-code-carbon-header-button-red-border, 0.5px solid #e0443e)}/*!@div.carbon > div.yellow*/div.carbon.sc-deckgo-highlight-code>div.yellow.sc-deckgo-highlight-code{background:var(--deckgo-highlight-code-carbon-header-button-yellow-background, #ffbd2e);border:var(--deckgo-highlight-code-carbon-header-button-yellow-border, 0.5px solid #dea123)}/*!@div.carbon > div.green*/div.carbon.sc-deckgo-highlight-code>div.green.sc-deckgo-highlight-code{background:var(--deckgo-highlight-code-carbon-header-button-green-background, #27c93f);border:var(--deckgo-highlight-code-carbon-header-button-green-border, 0.5px solid #1aab29)}/*!@div.ubuntu*/div.ubuntu.sc-deckgo-highlight-code{display:flex;justify-content:flex-start;align-items:center;padding:var(--deckgo-highlight-code-ubuntu-header-padding, 0 0.5em);height:var(--deckgo-highlight-code-ubuntu-header-height, 25px);background:var(--deckgo-highlight-code-ubuntu-header-background, linear-gradient(#504b45 0%, #3c3b37 100%));font-family:var(--deckgo-highlight-code-ubuntu-header-font-family, \"Ubuntu\")}/*!@div.ubuntu > div*/div.ubuntu.sc-deckgo-highlight-code>div.sc-deckgo-highlight-code{display:flex;align-items:center;justify-content:center;width:var(--deckgo-highlight-code-ubuntu-header-button-width, 12px);height:var(--deckgo-highlight-code-ubuntu-header-button-height, 12px);border-radius:var(--deckgo-highlight-code-ubuntu-header-button-border-radius, 50%);margin:var(--deckgo-highlight-code-ubuntu-header-button-margin, 0 0.25em 0 0);font-size:var(--deckgo-highlight-code-ubuntu-header-button-font-size, 0.4375em);color:var(--deckgo-highlight-code-ubuntu-header-button-color, black);text-shadow:var(--deckgo-highlight-code-ubuntu-header-button-text-shadow, 0px 1px 0px rgba(255, 255, 255, 0.2));box-shadow:var(--deckgo-highlight-code-ubuntu-header-button-box-shadow, 0px 0px 1px 0px #41403a, 0px 1px 1px 0px #474642)}/*!@div.ubuntu > div.close*/div.ubuntu.sc-deckgo-highlight-code>div.close.sc-deckgo-highlight-code{background:var(--deckgo-highlight-code-ubuntu-header-button-close-background, linear-gradient(#f37458 0%, #de4c12 100%));border:var(--deckgo-highlight-code-ubuntu-header-button-close-border)}/*!@div.ubuntu > div.minimize*/div.ubuntu.sc-deckgo-highlight-code>div.minimize.sc-deckgo-highlight-code{background:var(--deckgo-highlight-code-ubuntu-header-button-minimize-background, linear-gradient(#7d7871 0%, #595953 100%));border:var(--deckgo-highlight-code-ubuntu-header-button-minimize-border)}/*!@div.ubuntu > div.maximize*/div.ubuntu.sc-deckgo-highlight-code>div.maximize.sc-deckgo-highlight-code{background:var(--deckgo-highlight-code-ubuntu-header-button-maximize-background, linear-gradient(#7d7871 0%, #595953 100%));border:var(--deckgo-highlight-code-ubuntu-header-button-maximize-border)}/*!@div.ubuntu > div.close span, div.ubuntu > div.minimize span, div.ubuntu > div.maximize span*/div.ubuntu.sc-deckgo-highlight-code>div.close.sc-deckgo-highlight-code span.sc-deckgo-highlight-code,div.ubuntu.sc-deckgo-highlight-code>div.minimize.sc-deckgo-highlight-code span.sc-deckgo-highlight-code,div.ubuntu.sc-deckgo-highlight-code>div.maximize.sc-deckgo-highlight-code span.sc-deckgo-highlight-code{display:var(--deckgo-highlight-code-ubuntu-header-button-span-display, inherit)}/*!@div.ubuntu > p*/div.ubuntu.sc-deckgo-highlight-code>p.sc-deckgo-highlight-code{color:var(--deckgo-highlight-code-ubuntu-header-user-color, #d5d0ce);font-size:var(--deckgo-highlight-code-ubuntu-header-user-font-size, 12px);line-height:var(--deckgo-highlight-code-ubuntu-header-user-line-height, 14px);margin:var(--deckgo-highlight-code-ubuntu-header-user-margin, 0 0 1px 4px)}";

/**
 * @slot code - A `<code/>` element to highlight
 * @slot user - A user name for the Ubuntu terminal
 */
class DeckdeckgoHighlightCode {
  constructor(hostRef) {
  ...
  render() {
    ...
    return (hAsync(Host, { class: hostClass, onClick: () => this.edit() }, this.renderCarbon(), this.renderUbuntu(), this.renderHighlightStyle(), hAsync("div", { class: "container", ref: (el) => (this.refContainer = el) }, hAsync("code", { class: ((_a = this.highlightLines) === null || _a === void 0 ? void 0 : _a.length) > 0 ? 'highlight' : undefined, contentEditable: this.editable, onBlur: async () => await this.applyCode(), onInput: () => this.inputCode(), onKeyDown: ($event) => this.catchTab($event), ref: (el) => (this.refCode = el) }), hAsync("slot", { name: "code" }))));
  }
  renderHighlightStyle() {
    if (!this.highlightLines || this.highlightLines.length <= 0) {
      return undefined;
    }
    return hAsync(HighlightStyle, Object.assign({}, this.highlightRows));
  }
  renderCarbon() {
    if (this.terminal !== DeckdeckgoHighlightCodeTerminal.CARBON) {
      return undefined;
    ...
    return [
      hAsync(CarbonThemeStyle, { style: this.themeStyle }),
      hAsync("div", { class: "carbon" }, this.renderCarbonCircle('red'), this.renderCarbonCircle('yellow'), this.renderCarbonCircle('green'))
    ];
  }
  renderCarbonCircle(color) {
    return hAsync("div", { class: color });
  }
  renderUbuntu() {
    if (this.terminal !== DeckdeckgoHighlightCodeTerminal.UBUNTU) {
      return undefined;
    }
    return (hAsync("div", { class: "ubuntu" }, this.renderUbuntuCircle('close'), this.renderUbuntuCircle('minimize'), this.renderUbuntuCircle('maximize'), hAsync("p", null, hAsync("slot", { name: "user" }))));
  }
  renderUbuntuCircle(mode) {
    const symbol = mode === 'close' ? '&#10005;' : mode === 'minimize' ? '&#9472;' : '&#9723;';
    return (hAsync("div", { class: mode }, hAsync("span", { innerHTML: symbol })));
  }
  ...
  static get style() { return deckdeckgoHighlightCodeCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "deckgo-highlight-code",
    "$members$": {
      "language": [513],
    ...
    "$listeners$": [[4, "prismLanguageLoaded", "languageLoaded"]],
    "$lazyBundleId$": "-",
    "$attrsToReflect$": [["language", "language"], ["highlightLines", "highlight-lines"], ["lineNumbers", "line-numbers"], ["terminal", "terminal"], ["theme", "theme"]]
  }; }
}
...
var _3024Night = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$s
});
...
var a11yDark = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$r
});
...
var base16Dark = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$q
});
...
var base16Light = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$p
});
...
var blackboard = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$o
});
...
var cobalt = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$n
});
...
var duotone = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$m
});
...
var hopscotch = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$l
});
...
var lucario = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$k
});
...
var monokai = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$i
});
...
var nightOwl = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$h
});
...
var nord = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$g
});
...
var oceanicNext = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$f
});
...
var oneDark = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$e
});
...
var oneLight = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$d
});
...
var panda = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$c
});
...
var paraiso = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$b
});
...
var seti = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$a
});
...
var shadesOfPurple = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$9
});
...
var solarizedDark = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$8
});
...
var solarizedLight = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$7
});
...
var synthwave = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$6
});
...
var twilight = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$5
});
...
var verminal = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$4
});
...
var yeti = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$2
});
...
var zenburn = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme$1
});
...
var dracula = /*#__PURE__*/Object.freeze({
  __proto__: null,
  theme: theme
});
